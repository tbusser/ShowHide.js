	...
	exports.prototype = {
		...
		init: function(onInitCallback, context) {
			...
			for (; index < ubound; index++) {
				...
				// and closed
				trigger.addEventListener(options.triggerEvent, _onClickHandlerTrigger);
		...
		replaceTrigger: function(id, newElement) {
			...
			// to the new trigger
			trigger.removeEventListener(options.triggerEvent, _onClickHandlerTrigger);
			newElement.addEventListener(options.triggerEvent, _onClickHandlerTrigger);
